...
bool PointCloudCompressor::CompressFolder(
	...
	for (int i = 0; i < size; i++) {
		...
		if (in) {
			...
			CompressSingleFile(pcdList[i], pcdNameNTag, remove_duplicates, crop);
		}
	}	
...
bool PointCloudCompressor::DecompressSingleFile(
	...
	for (uint64_t lenFile = 0; lenFile < fileLength;) {
		...
		if		(lenToWrite % 8 == 0) {
			...
			case 15:
				...
				Y		   >>= 1; // +6 0111 1110
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 1; // +8 0111 1111 1111 1110
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 7; // +1 0111 1111 1111 1111
				Y			 = Y | T;
				pY			 = Y;
				pY			 = pY / 100;
				point.y		 = pY;
			...
			case 14:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 11;
				Y		   >>= 2; // +5 0011 1110 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 1; // +8 0011 1111 1111 1110
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 7; // +1
				Y			 = Y | T;
			...
			case 15:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 11;
				Y		   >>= 1; // +5 0111 1100 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 2; // +8 0111 1111 1111 1100
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 6; // +2
				Y			 = Y | T;
			...
			case 16:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 11;
				Y		   >>= 0; // +5 1111 1000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 3; // +8 1111 1111 1111 1000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 5; // +3
				Y			 = Y | T;
			...
			case 13:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 12; 
				Y		   >>= 3; // +4 0001 1110 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 1; // +8 0001 1111 1111 1110
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 7; // +1 0001 1111 1111 1111
				Y			 = Y | T;
				pY			 = Y;
				pY			 = pY / 100;
				point.y		 = pY;
			...
			case 14:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 12;
				Y		   >>= 2; // +4 0011 1100 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 2; // +8 0011 1111 1111 1100
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 6; // +2
				Y			 = Y | T;
			...
			case 15:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 12;
				Y		   >>= 1; // +4 0111 1000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 3; // +8 0111 1111 1111 1000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 5; // +3
				Y			 = Y | T;
			...
			case 16:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 12;
				Y		   >>= 0; // +4 1111 0000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 4; // +8 1111 1111 1111 0000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 4; // +4
				Y			 = Y | T;
			...
			case 12:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 13;
				Y		   >>= 4; // +3 0000 1110 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 1; // +8 0000 1111 1111 1110
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 7; // +1 0000 1111 1111 1111
				Y			 = Y | T;
				pY			 = Y;
				pY			 = pY / 100;
				point.y		 = pY;
			...
			case 13:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 13; 
				Y		   >>= 3; // +3 0001 1100 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 2; // +8 0001 1111 1111 1100
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 6; // +2 0001 1111 1111 1111
				Y			 = Y | T;
				pY			 = Y;
				pY			 = pY / 100;
				point.y		 = pY;
			...
			case 14:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 13;
				Y		   >>= 2; // +3 0011 1000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 3; // +8 0011 1111 1111 1000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 5; // +3
				Y			 = Y | T;
			...
			case 15:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 13;
				Y		   >>= 1; // +3 0111 0000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 4; // +8 0111 1111 1111 0000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 4; // +4
				Y			 = Y | T;
			...
			case 16:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 13;
				Y		   >>= 0; // +3 1110 0000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 5; // +8 1111 1111 1111 0000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 3; // +5
				Y			 = Y | T;
			...
			case 11:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 14;
				Y		   >>= 5; // +2 0000 0110 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 1; // +8 0000 0111 1111 1110
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 7;
				Y			 = Y | T;
			...
			case 12:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 14;
				Y		   >>= 4; // +2 0000 1100 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 2; // +8 0000 1111 1111 1100
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 6; // +2 0000 1111 1111 1111
				Y			 = Y | T;
				pY			 = Y;
				pY			 = pY / 100;
				point.y		 = pY;
			...
			case 13:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 14; 
				Y		   >>= 3; // +2 0001 1000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 3; // +8 0001 1111 1111 1000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 5; // +3 0001 1111 1111 1111
				Y			 = Y | T;
				pY			 = Y;
				pY			 = pY / 100;
				point.y		 = pY;
			...
			case 14:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 14;
				Y		   >>= 2; // +2 0011 0000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 4; // +8 0011 1111 1111 0000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 4; // +4
				Y			 = Y | T;
			...
			case 15:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 14;
				Y		   >>= 1; // +2 0110 0000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 5; // +8 0111 1111 1110 0000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 3; // +5
				Y			 = Y | T;
			...
			case 16:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 14;
				Y		   >>= 0; // +2 1100 0000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 6; // +8 1111 1111 1100 0000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 2; // +6
				Y			 = Y | T;
			...
			case 10:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 15;
				Y		   >>= 6; // +1 0000 0010 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 1; // +8 0111 1111 1111 1110
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 7; // +1 0000 0011 1111 1111
				Y			 = Y | T;
				pY			 = Y;
				pY			 = pY / 100;
				point.y		 = pY;
			...
			case 11:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 15;
				Y		   >>= 5; // +1 0000 0100 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 2; // +8 0000 0111 1111 1100
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 6; // +2
				Y			 = Y | T;
			...
			case 12:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 15;
				Y		   >>= 4; // +1 0000 1000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 3; // +8 0000 1111 1111 1000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 5; // +3 0000 1111 1111 1111
				Y			 = Y | T;
				pY			 = Y;
				pY			 = pY / 100;
				point.y		 = pY;
			...
			case 13:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 15; 
				Y		   >>= 3; // +1 0001 0000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 4; // +8 0001 1111 1111 0000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 4; // +4 0001 1111 1111 1111
				Y			 = Y | T;
				pY			 = Y;
				pY			 = pY / 100;
				point.y		 = pY;
			...
			case 14:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 15;
				Y		   >>= 2; // +1 0010 0000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 4; // +8 0011 1111 1110 0000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 3; // +5
				Y			 = Y | T;
			...
			case 15:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 15;
				Y		   >>= 1; // +1 0100 0000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 6; // +8 0111 1111 1100 0000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 2; // +6
				Y			 = Y | T;
			...
			case 16:
				Y			 = bitToWrite[lenToWrite / 8];
				Y		   <<= 15;
				Y		   >>= 0; // +1 1000 0000 0000 0000
				T			 = bitToWrite[lenToWrite / 8 + 1];
				T		   <<= 7; // +8 1111 1111 1000 0000
				Y			 = Y | T;
				T			 = bitToWrite[lenToWrite / 8 + 2];
				T		   >>= 1; // +7
				Y			 = Y | T;
	...
	if (pcl::io::savePCDFileBinaryCompressed(output_file, cloud_raw)) {
		std::cout << "ERROR: Cannot open pcd file " << std::endl;
		return -1;
	}
	fclose(compressFile);
...
bool PointCloudCompressor::DecompressFolder(
	...
	for (int i = 0; i < size; i++) {
		...
		if (in) {
			...
			DecompressSingleFile(mtxFilePath, pcdSaveName);
		}
	}
